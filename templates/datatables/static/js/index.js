let table = $('#datatables').DataTable({
    ...
    "columns": [
        ...
        {
            "data": null,
            "defaultContent": '<button type="button" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span> Modificar</button>' + '&nbsp;&nbsp' +
...
$('#new').on('click', function (e) {
    ...
    $('#codigo').val('');
    $('#type').val('new');
    $('#modal_title').text('Nueva Asignatura');
    $("#myModal").modal();
});
